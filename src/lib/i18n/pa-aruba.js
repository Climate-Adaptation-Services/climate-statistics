...
export const papiamentoAruba = {
    ...
    'explanationSeaLevelRiseTemplate': 'E grafico ta mustra e subida di nivel di lama relaciona cu e periodo {referencePeriod}, basa riba {scenariosLink}.{scenarioOriginExtra} E proyeccionnan ta mustra e rango den cua probablemente cambio climatico ta desaroya, dependiendo di e cantidad di gas di efecto invernadero cu ta emiti (SSP1-2.6 y SSP5-8.5) y e sensibilidad di e sistema climatico (e parti scur).',
    ...
    'chartDescClimate': 'Grafico di bara cu ta mustra clima actual (1991–2020) y proyeccionnan pa 2050 y 2100 bao di scenario abou y halto.',
    'chartTitleSeaLevel': 'Subida di nivel di lama pa {area}',
    'chartDescSeaLevel': 'Grafico di liña cu ta mustra subida proyectá di nivel di lama entre 1995 y 2100 bao di scenarionan di cambio climatico abou y halto, incluso e rango y un liña di punto pa e scenario mas halto posibel.',
