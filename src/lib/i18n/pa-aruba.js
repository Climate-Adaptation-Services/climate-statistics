...
export const papiamentoAruba = {
    ...
    'scenarioMild': 'Scenario moderado',
    'scenarioStrong': 'Scenario fuerte',
    'chooseTheme': 'Skoge un tema:',
    'chooseIndicator': 'Skoge un indicador:',
    'chooseSeason': 'Skoge un temporada:',
