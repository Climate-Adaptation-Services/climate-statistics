...
export const areas = {
  ...
  sm: {
    ...
    explanation: {
      en: {
        annual: 'The bars show the {variable} in the current climate (1991-2020, Princess Juliana Airport, <a href=" https://www.meteosxm.com/" target="_blank">MDS</a>) and for the future climate around 2050 and 2100  <a href="'+KNMI23_CLIMATE_SCENARIOS_URL+'" target="_blank">(KNMI 2023 scenarios)</a>. Future values are today’s averages multiplied by scenario-specific percentage changes. Change factors come from the regional Saba & St. Eustatius study, applied here until St. Martin-specific projections become available in late 2025. The bars show average values; changes in extremes are not included. The scenarios represent the range within which climate change is likely to develop. This range depends on both the amount of greenhouse gases emitted and the sensitivity of the climate system. The ‘low’ and ‘high’ scenarios reflect the two most widely differing scenarios.',
        seasonal: 'The bars show the {variable} during the {season} season ({seasonperiod}) in the current climate (1991-2020, Princess Juliana Airport, <a href=" https://www.meteosxm.com/" target="_blank">MDS</a>) and for the future climate around 2050 and 2100  <a href="'+KNMI23_CLIMATE_SCENARIOS_URL+'" target="_blank">(KNMI 2023 scenarios)</a>. Future values are today’s averages multiplied by scenario-specific percentage changes. Change factors come from the regional Saba & St. Eustatius study, applied here until St. Martin-specific projections become available in late 2025. The bars show average values; changes in extremes are not included. The scenarios represent the range within which climate change is likely to develop. This range depends on both the amount of greenhouse gases emitted and the sensitivity of the climate system. The ‘low’ and ‘high’ scenarios reflect the two most widely differing scenarios.',
        sealevelrise: 'The graph shows sea level rise relative to the period 1995 to 2014 <a href="'+KNMI23_CLIMATE_SCENARIOS_URL+'" target="_blank">(KNMI 2023 scenario’s)</a>. The projections come from the regional Saba & St. Eustatius study, applied here until St. Martin-specific projections become available in late 2025. The projections show the range within which climate change is likely to develop. This range depends on both the amount of greenhouse gases still being emitted (the two colors) and the sensitivity of the climate system (the shaded range).The dashed line shows the highest possible sea level rise. Current models consider this outcome unlikely, but because not all climate processes are fully understood it cannot be ruled out. To support preparedness for extreme cases, this scenario is included in the graph.',
      },
    },
    seasonperiod: {
      en: {
