...
export const areas = {
  ...
  sm: {
    ...
    explanation: {
      en: {
        annual: 'The bars show the {variable} in the current climate (1991-2020, Juliana Airport, <a href=" https://www.meteosxm.com/" target="_blank">MDS</a>) and for the future climate around 2050 and 2100  <a href="'+KNMI23_CLIMATE_SCENARIOS_URL+'" target="_blank">(KNMI 2023 scenarios)</a>. The bars show average values, changes in extremes are not included. The scenarios represent the range within which climate change is likely to develop. This range depends on both the amount of greenhouse gases being emitted and the sensitivity of the climate system. The ‘low’ and ‘high’ scenarios reflect the two most widely differing scenarios.',
